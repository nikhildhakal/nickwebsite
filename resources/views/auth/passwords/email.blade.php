  ...
  <div class="column is-one-third is-offset-one-third m-t-100">
    <div class="card">
      <div class="card-content">
        <h1 class="title">Get the Reset Link?</h1>
    ...
    <h5 class="has-text-centered m-t-15"><a href="{{route('login')}}" class="is-muted"><span class="fa fa-caret-left m-r-10"></span> Back to Login</a></h5>
  </div>
